...
const ServiceServices = require('./service.services.js');
const CategoryBusinessServices = require('./CategoryBusiness.services.js');
const GaleryServices = require('./galery.services.js');

module.exports = { AuthServices, UserServices, BusinessServices, ColaboratorServices, ClientServices, AppointmentServices, BFServices, ServiceServices, CategoryBusinessServices, GaleryServices };
